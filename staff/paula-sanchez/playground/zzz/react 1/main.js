...
const landingTitle = React.createElement(
  'h1',            // tipo de elemento
  null,            // props (no tiene)
...
const landingWelcome = React.createElement(
  'p',
  null,
  'Welcome!'
)
...
const landingLoginLink = React.createElement(
  'a',
...
const landingRegisterLink = React.createElement(
  'a',
  { href: '' },
  'Register'
)
...
*/
const landingNavigation = React.createElement(
  'nav',
  null,
  [landingLoginLink, ' or ', landingRegisterLink]
)
...
/* Crea un <div> contenedor del landing completo:
 ...
 - navegación
*/
const landingView = React.createElement(
  'div',
  null,
  [landingTitle, landingWelcome, landingNavigation]
)
